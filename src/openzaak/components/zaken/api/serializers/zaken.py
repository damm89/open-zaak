...
class ZaakSerializer(
    ...
    inclusion_serializers = {
        ...
        "hoofdzaak.status.statustype": "openzaak.components.catalogi.api.serializers.ZaakTypeSerializer",
        ...
        # "zaakinformatieobjecten.informatieobject.informatieobjecttype": "openzaak.components.catalogi.api.serializers.InformatieObjectTypeSerializer",
